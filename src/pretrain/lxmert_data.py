...
class LXMERTTorchDataset(Dataset):
    def __init__(self, dataset: LXMERTDataset, topk=-1):
        ...
        for img_datum in img_data:
            self.imgid2img[img_datum['img_id']] = img_datum  ###{img_id : all information}
        ...
        for datum in used_data:
            ...
            for sents_cat, sents in sentf.items():
                ...
                for sent_idx, sent in enumerate(sents):
                    ...
                    self.data.append(new_datum) #[{'uid': ('COCO_train2014_000000579846_mscoco_000',), 'img_id': 'COCO_train2014_000000579846', 'sent': 'A nearly empty house with a bicycle mounted on the wall.'}]
                    # pdb.set_trace()
